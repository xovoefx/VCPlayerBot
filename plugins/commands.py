...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/musicxsupport'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/xovo_efx')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/musicxsupport'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/musicxsupport'),     
        ],
        [
            InlineKeyboardButton("🎞 How to Deploy", url='https://t.me/musicxsupport'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is not public.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
